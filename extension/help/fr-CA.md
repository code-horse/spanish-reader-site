...
Lorsque le mode page entière est activé, chaque mot espagnol reçoit une annotation de prononciation au-dessus, via le ruby text.
...
Sélectionnez du texte, puis cliquez sur **Traduire** dans la barre.

**Méthode 2 : menu contextuel**  
Sélectionnez du texte, clic droit, puis **Traduire la sélection**.
